...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "MAX_REPLAY_CNT" -parent ${Page_0}
...
proc update_PARAM_VALUE.MAX_REPLAY_CNT { PARAM_VALUE.MAX_REPLAY_CNT } {
	# Procedure called to update MAX_REPLAY_CNT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.MAX_REPLAY_CNT { PARAM_VALUE.MAX_REPLAY_CNT } {
	# Procedure called to validate MAX_REPLAY_CNT
	return true
}
...
proc update_MODELPARAM_VALUE.MAX_REPLAY_CNT { MODELPARAM_VALUE.MAX_REPLAY_CNT PARAM_VALUE.MAX_REPLAY_CNT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.MAX_REPLAY_CNT}] ${MODELPARAM_VALUE.MAX_REPLAY_CNT}
}
