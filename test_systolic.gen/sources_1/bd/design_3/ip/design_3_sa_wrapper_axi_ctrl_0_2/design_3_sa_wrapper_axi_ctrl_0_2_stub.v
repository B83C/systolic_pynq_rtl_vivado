...
//               /home/b83c/git/systolic/test_systolic/test_systolic.gen/sources_1/bd/design_3/ip/design_3_sa_wrapper_axi_ctrl_0_2/design_3_sa_wrapper_axi_ctrl_0_2_stub.v
...
(* CHECK_LICENSE_TYPE = "design_3_sa_wrapper_axi_ctrl_0_2,sa_wrapper_axi_ctrl,{}" *) (* CORE_GENERATION_INFO = "design_3_sa_wrapper_axi_ctrl_0_2,sa_wrapper_axi_ctrl,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=sa_wrapper_axi_ctrl,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,A_DEPTH=64,C_DEPTH=8,ACCUM_WIDTH=32,SIZE=8,DATA_WIDTH_IN=8,DATA_WIDTH_OUT=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
...
/* synthesis syn_black_box black_box_pad_pin="rst_n,s_axis_B_tdata[63:0],s_axis_B_tvalid,s_axis_B_tready,s_axis_B_tlast,m_axis_tdata[255:0],m_axis_tvalid,m_axis_tready,m_axis_tlast,s_axil_awvalid,s_axil_awready,s_axil_awaddr[6:0],s_axil_wdata[31:0],s_axil_wvalid,s_axil_wready,s_axil_bresp[1:0],s_axil_bvalid,s_axil_bready,s_axil_arvalid,s_axil_arready,s_axil_araddr[6:0],s_axil_rdata[31:0],s_axil_rresp[1:0],s_axil_rvalid,s_axil_rready" */
