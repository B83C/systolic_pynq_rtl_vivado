...
entity design_3_sa_wrapper_axi_ctrl_0_2 is
  Port ( 
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
  ...
  attribute IP_DEFINITION_SOURCE of design_3_sa_wrapper_axi_ctrl_0_2 : entity is "module_ref";
end design_3_sa_wrapper_axi_ctrl_0_2;

architecture stub of design_3_sa_wrapper_axi_ctrl_0_2 is
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF m_axis:s_axis_B:s_axil, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_3_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of m_axis_tdata : signal is "XIL_INTERFACENAME m_axis, TDATA_NUM_BYTES 32, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, CLK_DOMAIN design_3_processing_system7_0_0_FCLK_CLK0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute X_CORE_INFO of stub : architecture is "sa_wrapper_axi_ctrl,Vivado 2025.2";
begin
end;
